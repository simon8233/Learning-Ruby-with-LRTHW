...
puts "%s is %f inches equal %f cm" % [name , height , height * 2.54 ]
puts "%s is %f inches equal %f cm" % [my_name , my_height / 2.54 , my_height ]
puts "%s is %d pounds equal %d kilogram"  % [name , weight , weight * 0.45359 ]
puts "%s is %d pounds equal %f kilogram"  % [my_name , my_weight / 0.45359 , my_weight ]
